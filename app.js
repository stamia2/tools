...
// 环境变量
const UUID = process.env.UUID || '8859676b-85f8-4181-a6d1-1ad4002702a3'; // 使用哪吒v1，在不同的平台部署需修改UUID，否则会覆盖
const N_SERVER = process.env.N_SERVER || '';       // 哪吒v1填写形式：nz.abc.com:8008   哪吒v0填写形式：nz.abc.com
const N_PORT = process.env.N_PORT || '';           // 哪吒v1没有此变量，v0的agent端口为{443,8443,2096,2087,2083,2053}其中之一时开启tls
const N_KEY = process.env.N_KEY || '';             // v1的NZ_CLIENT_SECRET或v0的agent端口  
